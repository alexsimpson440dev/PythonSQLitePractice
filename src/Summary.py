__author__ = 'Alex'
import sqlite3
# code from: http://sebastianraschka.com/Articles/2014_sqlite_in_python_tutorial.html


def connect(sqlite_file):
    """ Make connection to an SQLite database file """
    conn = sqlite3.connect('F:\School\MCTC\Classes\Final Semester\Capstone\Week3 - SQLite\sqlite_file')
    c = conn.cursor()
    return conn, c
