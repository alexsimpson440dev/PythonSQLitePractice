...
class SQL():
    def __init__(self):
        ...
        self.unique_index = "Unique Index"
    ...
    def add_unique_index(self):
        self.c.execute('CREATE INDEX {ix} on {tn}({cn})'\
                .format(ix=self.unique_index, tn=self.employees_table, cn=self.employeename_field))
    ...
    def drop_unique(self):
        ...
        self.c.execute('DROP INDEX {ix}'.format(ix=self.unique_index))
